...
[root@puppetmaster.laterpay.net puppet]# cat modules/dashboard/manifests/
init.pp       params.pp     passenger.pp
[root@puppetmaster.laterpay.net puppet]# cat modules/dashboard/manifests/init.pp
